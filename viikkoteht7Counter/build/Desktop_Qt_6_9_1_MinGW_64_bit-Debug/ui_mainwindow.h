...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        count->setGeometry(QRect(50, 40, 80, 18));
        reset = new QPushButton(centralwidget);
        reset->setObjectName("reset");
        reset->setGeometry(QRect(50, 90, 80, 18));
        countEdit = new QLineEdit(centralwidget);
        countEdit->setObjectName("countEdit");
        countEdit->setGeometry(QRect(200, 70, 113, 20));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        countEdit->setText(QCoreApplication::translate("MainWindow", "0", nullptr));
    } // retranslateUi
